...
func UserClaims(id string, username string, scope []string) jwt.Claims {
...
func UserToken(id string, username string, scope []string) string {
	return TokenFromClaims(UserClaims(id, username, scope))
}
...
func DerivedUserToken(id string, username string, apps map[string]types.Right, gateways map[string]types.Right, components map[string]types.Right) string {
	return TokenFromClaims(DerivedUserClaims(id, username, apps, gateways, components))
}
